...
% the given test.
    if ~currentStatus.skip
        ...
        ref_error_c = currentStatus.plotStage.error;
        gen_error_c = currentStatus.tikzStage.error;

        ref_file_c  = currentStatus.saveStage.texReference;
        gen_file_c  = currentStatus.tikzStage.pdfFile;
        ...
        stream.print(...
                ...
                '\\end{figure}\n'                                             , ...
                '\\clearpage\n\n'],...
                include_figure(ref_error_c, 'includegraphics', ref_file_c), ...
                include_figure(gen_error_c, 'includegraphics', gen_file_c), ...
                include_figure(ref_error_o, 'includegraphics', ref_file_o), ...
                include_figure(gen_error_o, 'includegraphics', gen_file_o), ...
                currentStatus.description, ...
                name2tex(currentStatus.function), name2tex(currentStatus.testsuite), currentStatus.index, ...
                formatIssuesForTeX(currentStatus.issues));
    end
end
% =========================================================================
